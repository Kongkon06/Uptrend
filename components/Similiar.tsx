...
export function Suggestion(){
    ...
    return  <div className="h-full p-3 flex justify-center gap-20 ">
    <div role="button" onClick={()=>{router.push('/Product/7')}} className="max-w-sm rounded overflow-hidden shadow-lg ">
    ...
    <div  role="button" onClick={()=>{router.push('/Product/8')}} className="max-w-sm rounded overflow-hidden shadow-lg ">
    ...
    <div  role="button" onClick={()=>{router.push('/Product/12')}} className="max-w-sm rounded overflow-hidden shadow-lg ">
